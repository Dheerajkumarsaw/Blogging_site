...
```
{
  ...
  category: {string, mandatory, examples: [technology, entertainment, life style, food]},
  subcategory: {array of string, examples[technology-[web development, mobile development, AI ML]] },
  createdAt,
  updatedAt,
...
- Allow an author to login with their email and password. On a successful login attempt return a JWT token containing the authorId
